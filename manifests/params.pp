...
class prometheus::params {
  ...
  $cloudwatch_exporter_group = 'cloudwatch-exporter'
  $cloudwatch_exporter_download_extension = 'tar.gz'
  $cloudwatch_exporter_download_url_base = ''
  ...
  $cloudwatch_exporter_config_file = '/etc/cloudwatch-exporter.yaml'
  $cloudwatch_exporter_version = '0.1.0'
  $cloudwatch_exporter_web_telemetry_path = '/cloudwatch-metrics'
  $cloudwatch_exporter_web_listen_address = 'localhost:9042'
  $cloudwatch_exporter_scrape_telemetry_path = '/cloudwatch-scrape'
